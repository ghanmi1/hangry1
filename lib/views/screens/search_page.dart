...
class _SearchPageState extends State<SearchPage> {
  ...
  List<Recipe> allRecipe = RecipeHelper.allRecipe2;
  List<Recipe> allRecipeOnSearch = [];

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    allRecipeOnSearch = allRecipe;
  }

  void _search(String value) {
    final suggestions = allRecipe.where((element) {
      return element.title.toLowerCase().contains(value.toLowerCase());
    }).toList();
    setState(() {
      allRecipeOnSearch = suggestions;
    });
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  shrinkWrap: true,
                  itemCount: allRecipeOnSearch.length,
                  physics: NeverScrollableScrollPhysics(),
                  itemBuilder: (context, index) {
                    return RecipeTile(
                      data: allRecipeOnSearch[index],
                    );
                  },
                ),
              ],
